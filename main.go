...
import (
	...
	_ "github.com/appmaxbrasil/appstore-backend-example/config"
	"github.com/appmaxbrasil/appstore-backend-example/database/migrations"
	"github.com/appmaxbrasil/appstore-backend-example/routes"
)
