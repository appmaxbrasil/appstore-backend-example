...
| Resource | Link |
|----------|------|
| Postman Documentation and Collection | <a href="https://www.postman.com/appmax-developers/appmax-s-developers/collection/41200535-902bfcf7-5eb9-437d-beee-cf425886bc97?sideView=agentMode" target="_blank"><img src="https://run.pstmn.io/button.svg" alt="Run in Postman"></a> |
...
```bash
git clone https://github.com/appmaxbrasil/appstore-backend-example.git
cd appstore-backend-example
```
