...
|--------------------------|--------------|-----------------------------|---------------------------------------------------------------------------|
| `APPMAX_APP_ID_UUID`     | UUID string  | Appmax dashboard            | `GET /install/start` validation, `POST /app/authorize` request             |
| `APPMAX_APP_ID_NUMERIC`  | Integer      | Appmax dashboard            | `POST /integrations/appmax/callback/install` health check validation       |
...
|--------------------------|----------------------------|--------------|----------------------|
| `APPMAX_CLIENT_ID`       | Appmax dashboard (manual)  | `.env`       | All installations    |
| `APPMAX_CLIENT_SECRET`   | Appmax dashboard (manual)  | `.env`       | All installations    |
...
Both values come from the Appmax dashboard and must be set in environment variables.
...
| Symptom                                | Cause                                         | Fix                                                    |
|----------------------------------------|-----------------------------------------------|--------------------------------------------------------|
| 400 `"invalid app_id"`                 | `APPMAX_APP_ID_NUMERIC` env var doesn't match  | Check Appmax dashboard for the numeric app ID          |
...
|-------------------------|----------|----------------------------------|---------------------------------------------------|
| `APPMAX_CLIENT_ID`      | Yes      | -                                | App-level OAuth client ID                         |
| `APPMAX_CLIENT_SECRET`  | Yes      | -                                | App-level OAuth client secret                     |
| `APPMAX_APP_ID_UUID`    | Yes      | -                                | App UUID from Appmax dashboard                    |
| `APPMAX_APP_ID_NUMERIC` | Yes      | -                                | App numeric ID from Appmax dashboard              |
