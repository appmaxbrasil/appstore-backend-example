...
|--------------------------|--------------|-----------------------------|---------------------------------------------------------------------------|
| `APPMAX_APP_ID_UUID`     | UUID string  | The credentials provided by Appmax            | `GET /install/start` validation, `POST /app/authorize` request             |
| `APPMAX_APP_ID_NUMERIC`  | Integer      | The credentials provided by Appmax            | `POST /integrations/appmax/callback/install` health check validation       |
...
|--------------------------|----------------------------|--------------|----------------------|
| `APPMAX_CLIENT_ID`       | The credentials provided by Appmax (manual)  | `.env`       | All installations    |
| `APPMAX_CLIENT_SECRET`   | The credentials provided by Appmax (manual)  | `.env`       | All installations    |
...
Both values come from the The credentials provided by Appmax and must be set in environment variables.
